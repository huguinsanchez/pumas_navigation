...
class looking_for_objects(Takeshi_states):
    def takeshi_run(self):
        global  rot, trans
...
class go_to_shelf(Takeshi_states):
    def takeshi_run(self):
        ...
        try:
            omni_base.getClose(goal_x, goal_y, goal_yaw,7)
            return True
        except:
            return False
...
if __name__== '__main__':
    ...
    with sm:
        ...
        smach.StateMachine.add("LOOKING_FOR_OBJECTS",    looking_for_objects(),  transitions = {'failed':'END',                  'succ': 'END',                  'tries':'END'}) 
